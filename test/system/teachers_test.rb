...
class TeachersTest < ApplicationSystemTestCase
  ...
  test "should create teacher" do
    ...
    fill_in "Adhar no", with: @teacher.adhar_no
    fill_in "Department", with: @teacher.department
    fill_in "Email", with: @teacher.email
    fill_in "Faculty no", with: @teacher.faculty_no
    fill_in "License", with: @teacher.license
    fill_in "Name", with: @teacher.name
    fill_in "Phone", with: @teacher.phone
    fill_in "Vehicle no", with: @teacher.vehicle_no
